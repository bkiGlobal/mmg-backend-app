...
from .models import *
# from finance.serializers import BillOfQuantitySerializer, FinanceDataSerializer, PaymentRequestSerializer, ExpenseOnProjectSerializer, PettyCashSerializer
# from inventory.serializers import MaterialOnProjectSerializer, ToolOnProjectSerializer
# from team.serializers import SubContractorOnProjectSerializer, ProfileSimpleSerializer, TeamSerializer, SignatureSerializer, InitialSerializer
from core.serializers import *
# from project.serializers import ProjectSimpleSerializer
# from finance.serializers import BillOfQuantitySerializer
...
class ScheduleSerializer(serializers.ModelSerializer):
    # boq_item = BillOfQuantitySerializer(read_only=True)
