...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('finance', '0010_alter_expensedetail_unit_and_more'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('issue_date', models.DateField(default=django.utils.timezone.now, verbose_name='Upload Date')),
                ('due_date', models.DateField(blank=True, null=True, verbose_name='Deadline Date')),
                ...
                ('project', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='project_payment_requests', to='project.project')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('total', djmoney.models.fields.MoneyField(decimal_places=2, default=Decimal('0'), default_currency='IDR', max_digits=16)),
                ('payment_file', models.FileField(upload_to=finance.models.upload_payment_request)),
                ('payment_number', models.CharField(max_length=255)),
                ('notes', models.TextField()),
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created_by', to=settings.AUTH_USER_MODEL)),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_deleted_by', to=settings.AUTH_USER_MODEL)),
                ('payment_request', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment_versions', to='finance.paymentrequest')),
                ('updated_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_updated_by', to=settings.AUTH_USER_MODEL)),
            ],
            options={
                'abstract': False,
        ...
        migrations.CreateModel(
            name='SignatureOnPaymentRequest',
            fields=[
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('is_deleted', models.BooleanField(default=False)),
                ...
                ('created_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_created_by', to=settings.AUTH_USER_MODEL)),
                ('deleted_by', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='%(class)s_deleted_by', to=settings.AUTH_USER_MODEL)),
                ('document', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='payment_request_signatures', to='finance.paymentrequest')),
